...
//   console.log("getVariableDataTypes() called");

//   // Create wrapper for message pair
//   const chatOutput = document.getElementById("chat-output");
//   const wrapper = document.createElement("div");
//   wrapper.className = "chat-pair";
...
//   const userMessage = document.createElement("div");
//   userMessage.className = "message user-message";
//   userMessage.textContent = "Tell me about Variables and Data Types in Python.";
//   wrapper.appendChild(userMessage);
...
//     // Remove loading message and display code + explanation
//     wrapper.removeChild(botMessage);
//     displayCode(data.code, data.explanation, wrapper);
//   } catch (error) {
//     console.error("Error fetching Variable_DataTypes response:", error);
//     botMessage.textContent = "Error: Unable to get a response from the server.";
//   }
// }
...
//   console.log("Introducing_list() called");
...
//   const userMessage = document.createElement("div");
//   userMessage.className = "message user-message";
//   userMessage.textContent = "Tell me about introducing lists in Python.";
//   wrapper.appendChild(userMessage);
